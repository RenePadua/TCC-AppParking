...
<html lang="pt-br">
  ...
  <body> 
	<?php
		...
		// Query: Excluir a marca da tabela 'marca'
		$query_delete_marca = "DELETE FROM marca WHERE nm_Marca = '$putMarca'";
		$result_delete_marca = mysqli_query($conn, $query_delete_marca);
		
		// Verificar se a query foi executada com sucesso
		if ($result_delete_marca) {
			// Registrar a movimentação na tabela de logs
				$acaoRealizada = "Excluiu a marca: $putMarca";
			...
			echo "Erro ao excluir a marca: " . mysqli_error($conn);
		}
